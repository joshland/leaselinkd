...
`kea-lease-manager` is an event-driven Kea DHCPv4 → OPNsense Unbound bridge, currently version `1.9.7`. It uses a lightweight **agent** model: each executable has one responsibility.
