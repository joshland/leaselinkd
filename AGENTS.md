...
`leaselinkd` is an event-driven Kea DHCPv4 → OPNsense Unbound bridge, currently version `3.0.3`. It uses a lightweight **agent** model: each executable has one responsibility.
